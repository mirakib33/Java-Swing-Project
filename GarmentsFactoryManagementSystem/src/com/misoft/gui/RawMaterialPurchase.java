 ...
 * @author hp
 */
public class RawMaterialPurchase extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "insert into raw_material_purchase (order_no, supplier, item, category, color, size, quantity, unit_price, total_price, description) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql = "update raw_material_purchase set order_no=?, supplier=?, item=?, category=?, color=?, size=?, quantity=?, unit_price=?, total_price=?, description=? Where order_no=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RawMaterialPurchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RawMaterialPurchase().setVisible(true);
            }
        });
    }
